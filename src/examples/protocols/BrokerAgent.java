...
public class BrokerAgent extends Agent {
	private static final long serialVersionUID = -3186303389795350208L;
	...
	protected void setup() {
		...
		if (args != null && args.length > 0) {
			...
			AchieveREResponder arer = new AchieveREResponder(this, template) {
				private static final long serialVersionUID = -770500741216868558L;
			...
			arer.registerPrepareResultNotification(new AchieveREInitiator(this, null) {
				private static final long serialVersionUID = -2427404308665431973L;
