 ...
 * each time a given service is published in the yellow pages catalog. In this
...
public class DFSubscribeAgent extends Agent {
	private static final long serialVersionUID = -3803533905680583288L;
	...
	protected void setup() {
		...
		addBehaviour(new SubscriptionInitiator(this,
			...
			private static final long serialVersionUID = 1385881995117765018L;
