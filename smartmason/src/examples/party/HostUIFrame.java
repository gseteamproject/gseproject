...
public class HostUIFrame extends JFrame {
	...
	// Instance variables
	//////////////////////////////////
	private static final long serialVersionUID = 7592703482412394598L;
	...
	/**
	 * When the slider for the number of guests changes, we update the label.
	 */
	...
	void btn_start_actionPerformed(ActionEvent e) {
		...
		// add a behavior to the host to start the conversation going
		m_owner.addBehaviour(new OneShotBehaviour() {
			private static final long serialVersionUID = -6886560441121125579L;
	...
	void btn_stop_actionPerformed(ActionEvent e) {
		...
		m_owner.addBehaviour(new OneShotBehaviour() {
			private static final long serialVersionUID = 6470470455803647363L;
	...
	/**
	 * Maintains the enabled/disabled state of key controls, depending on
	...
	void btn_Exit_actionPerformed(ActionEvent e) {
		m_owner.addBehaviour(new OneShotBehaviour() {
			private static final long serialVersionUID = 8161406390863452255L;
