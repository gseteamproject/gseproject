 ...
 * random, and tells them a rumor. The host then selects two other guests at
 ...
 * themselves, and the guest knows the rumor, they tell the other guest. When a
 * guest hears the rumor for the first time, they notify the host. When all the
 * guests have heard the rumor, the party ends and the guests leave.
 * </p>
 * <p>
...
public class HostAgent extends Agent {
	...
	private static final long serialVersionUID = 7690988596389900981L;
	...
	protected void setup() {
		try {
			...
			// add a Behavior to handle messages from guests
			addBehaviour(new CyclicBehaviour(this) {
				private static final long serialVersionUID = -6312827269596646114L;
				...
				public void action() {
					...
					if (msg != null) {
						if (HELLO.equals(msg.getContent())) {
							...
							// count the agents who have heard the rumor
	...
	/**
	 * Start the conversation in the party. Tell a random guest a rumor, and
	 ...
	 * count on the UI, and the average number of introductions per rumor.
	 */
	...
	/**
	 * Increment the number of guests that have heard the rumor, and update the
	 * UI. If all guests have heard the rumor, end the party.
	 */
	protected void incrementRumourCount() {
		...
		// when all the guests have heard the rumor, the party ends
	...
	/**
	 * Update the average number of introductions per rumor spread in the UI.
	 */
