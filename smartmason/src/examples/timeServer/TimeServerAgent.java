...
/**
 * This agent shows how to use an OntologyServer behavior to serve incoming
 * messages (REQUESTs in this case) referring to a given ontology. In this
...
public class TimeServerAgent extends Agent {
	private static final long serialVersionUID = -8855472217581809524L;
	private long time0;
	...
	protected void setup() {
		...
		// Add the behavior serving REQUESTs to perform actions in the
		// TimeOntology
