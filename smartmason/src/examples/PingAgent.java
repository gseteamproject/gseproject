	...
	public void setup()
	{
		...
		addBehaviour(new CyclicBehaviour(this)
		{
			...
			public void action()
			{
				...
				// блокирование поведения, пока в очереди сообщений агента, не появиться хотя бы одно сообщение
				block();
			}
		});
		...
		for(AMSAgentDescription agent : agents)
		{
			...
			msg.addReceiver(agentID); // id агента, которому отправляется сообщение
